      ...
      className='col-span-1 cursor-pointer group bg-black bg-opacity-70 text-white rounded-xl'>
        <div className='flex flex-col gap-2 w-full'>
          ...
          <div className="flex justify-center">
            <Link to={`package/${_id}`}><button className="bg-[#16CAC9] hover:bg-[#F99615] text-white text-center text-base font-medium rounded-lg uppercase p-3 mr-5 my-2">ViewDetails</button></Link>
          </div>
          </div>
        </div>
      </motion.div>
