...
const ContactUs = () => {
    return (
        ...
        <Helmet>
                <title>Top Ten Travel | Contact Us</title>
            </Helmet>
            <div className='mx-10 mb-10'>
			<h1 className='text-center text-3xl font-bold w-1/2 bg-[#16CAC9] text-white block mx-auto py-2 rounded-lg border-red-500 border-l-4 border-r-4 my-6'>
						...
						<div className='card flex-shrink-0 w-full shadow-2xl bg-base-100 py-4'>
							<div className='card-body'>
								...
								<div className='form-control mt-6'>
									<button className='text-white text-center py-3 px-5 bg-[#16CAC9] rounded-md font-semibold'>Send</button>
								</div>
							</div>
						</div>
					</div>
